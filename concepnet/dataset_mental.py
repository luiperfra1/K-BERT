...
df = pd.read_csv("mental_health.csv", on_bad_lines='skip')
...
train_df.to_csv("mental/train.tsv", sep="\t", index=False)
dev_df.to_csv("mental/dev.tsv", sep="\t", index=False)
test_df.to_csv("mental/test.tsv", sep="\t", index=False)
